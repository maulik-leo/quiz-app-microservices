## 🚀 quiz-service : Quiz App (Microservices) by LeoTech India
...
* The original package name 'com.leotechindia.quiz-service' is invalid and this project uses 'com.leotechindia.quiz_service' instead.
