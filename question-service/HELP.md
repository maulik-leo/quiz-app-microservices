## 🚀 question-service : Quiz App (Microservices) by LeoTech India
...
* The original package name 'com.leotechindia.question-service' is invalid and this project uses 'com.leotechindia.question_service' instead.
